...
#En este punto la librería class cuenta con la función knn que se encarga de recibir el conjunto de training y testing, así como predecir automáticamente la categoría en función de la variable que se pretende predecir.
...
#En esencia el KNN sigue la misma mecanica de los modelos vistos anteriormente pero engloba todos los pasos realizar el entrenamiento y predicción en un único paso (todo se hace internamente en la función).
library(class)
...
#Exactamente igual que lo visto en el modelo de clasificación logistico.
#Se intenta generar una table para saber el porcentaje de acierto y error con el dataset de prueba.

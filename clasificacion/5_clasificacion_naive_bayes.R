...
#Tal como se ha visto en el paso 2, el parámetro "y" de la función naiveBayes recibe como argumento un factor,
#por lo tanto en el dataset lo que se ha hecho es precisamente generar un factor con las posibles categorías para la variable dependiente "Purchased"
#que en este caso son simplemente 0 y 1.
library(e1071)
